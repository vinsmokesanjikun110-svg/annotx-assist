...
import { 
  ...
  Hand, Maximize, RotateCw, Save, Sparkles, Square, ZoomIn, ZoomOut 
} from "lucide-react";
    ...
    <div className="h-screen flex flex-col bg-background">
      ...
      <header className="border-b border-border bg-card/50 backdrop-blur-sm px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="font-semibold">Chest X-Ray Pneumonia Detection</h1>
            <p className="text-xs text-muted-foreground">Case 0145 - Axial View</p>
          </div>
        </div>
          ...
          <div className="flex-1 bg-background/50 relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="relative w-full max-w-3xl aspect-square mx-4">
                <Card className="w-full h-full border-2 border-dashed border-border/50 flex items-center justify-center bg-muted/20">
                  <div className="text-center">
                    <Activity className="w-16 h-16 mx-auto mb-4 text-muted-foreground" />
                    <p className="text-muted-foreground">Medical Image Canvas</p>
                    <p className="text-xs text-muted-foreground mt-2">DICOM viewer will be rendered here</p>
                  </div>
                </Card>
                {aiAssistActive && (
